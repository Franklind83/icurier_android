...
public class WalletAdapter1 extends RecyclerView.Adapter<WalletAdapter1.MyViewHolder> {
    Context context;
    List<OrderListItem> orderList;
    String Type ="";

    public WalletAdapter1(Context context) {
    ...
    @Override
    public WalletAdapter1.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        WalletItemBinding binding= DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.wallet_item,parent,false);
        return  new WalletAdapter1.MyViewHolder(binding);
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    @Override
    public void onBindViewHolder(final WalletAdapter1.MyViewHolder holder, final int position) {
